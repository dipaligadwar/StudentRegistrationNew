<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LP_Reports.aspx.cs" MasterPageFile="~/Home.Master" Inherits="StudentRegistration.Eligibility.LP_Reports" %>
			...
			<CENTER>
				<TABLE id="table1" style="BORDER-COLLAPSE: collapse" borderColor="#c0c0c0" cellPadding="2"
					...
					<tr>						
                        ...
                        <asp:Label ID="lblPageHead" runat="server" Text="Reports"></asp:Label>
				        </TD>
					</tr>
