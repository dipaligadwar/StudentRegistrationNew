...
namespace StudentRegistration.Eligibility
{
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_FetchUniversityWiseDistricts",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"GEN_districtWiseTaluka",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_fetchcollegelist",pr);
    //			}
    //			
    //			catch(Exception Ex)
    //			{
    ...
    //		}
        ...
        #region fetch student details for manual process for registered student without Invoice bypass

        public static DataSet IA_Fetch_Student_Details(string pk_Uni_ID, string pk_Student_ID, string pk_Year, string Ref_Uni_ID, string Ref_Institute_ID, string Ref_Year, string Ref_Student_ID, string fk_Fac_ID, string fk_Cr_ID, string fk_MoLrn_ID, string fk_Ptrn_ID, string fk_Brn_ID, string fk_CrPrDetails_ID, string AdmissionFormNo)
	    {	
		    DataSet ds = new DataSet();
		    ...
		    try
		    {
                ...
                ht.Add("Admission_Form_No",AdmissionFormNo );

                

                ds = oDB.getparamdataset("ELGV2_Fetch_REG_Student_Details", ht);
			    return ds;
        ...
        #region fetch student details for bulk process for Unregistered students/ registered students

        public static DataSet IA_Fetch_Student_Details_BulkInsert(string pk_Uni_ID, string pk_Student_ID, string pk_Year, string Ref_Uni_ID, string Ref_Institute_ID, string Ref_Year, string Ref_Student_ID, string fk_Fac_ID, string fk_Cr_ID, string fk_MoLrn_ID, string fk_Ptrn_ID, string fk_Brn_ID, string fk_CrPrDetails_ID)
        {
            DataSet ds = new DataSet();
            //SqlParameter[] pr = new SqlParameter[4];
            Hashtable ht = new Hashtable();
            ...
            try
            {
               ...
               ds = oDB.getparamdataset("ELGV2_Fetch_REG_Student_Details_BulkInsert ", ht);
                return ds;
        ...
        #region fetch student details for manual process for registered student with Invoice bypass
        public static DataSet IA_Fetch_Student_Details_bypassInv(string pk_Uni_ID, string pk_Student_ID, string pk_Year, string Ref_Uni_ID, string Ref_Institute_ID, string Ref_Year, string Ref_Student_ID, string fk_Fac_ID, string fk_Cr_ID, string fk_MoLrn_ID, string fk_Ptrn_ID, string fk_Brn_ID, string fk_CrPrDetails_ID, string AdmissionFormNo)
        {
            DataSet ds = new DataSet();
            //SqlParameter[] pr = new SqlParameter[4];
            Hashtable ht = new Hashtable();
            ...
            try
            {
                ...
                ds = oDB.getparamdataset("ELGV2_Fetch_REG_Student_Details_bypassInv", ht);
                return ds;
        ...
        public static DataSet IA_Fetch_Student_Details_RegStu(string pk_Uni_ID, string pk_Student_ID, string pk_Year, string Ref_Uni_ID, string Ref_Institute_ID, string Ref_Year, string Ref_Student_ID, string fk_Fac_ID, string fk_Cr_ID, string fk_MoLrn_ID, string fk_Ptrn_ID, string fk_Brn_ID, string fk_CrPrDetails_ID)
        {
            DataSet ds = new DataSet();
            //SqlParameter[] pr = new SqlParameter[4];
            Hashtable ht = new Hashtable();
            ...
            try
            {
                ...
                ds = oDB.getparamdataset("ELGV2_Fetch_REG_Student_Details_RegStu", ht);
                return ds;
        ...
        public static DataSet IA_Fetch_Student_Details_RegStu_bypassInv(string pk_Uni_ID, string pk_Student_ID, string pk_Year, string Ref_Uni_ID, string Ref_Institute_ID, string Ref_Year, string Ref_Student_ID, string fk_Fac_ID, string fk_Cr_ID, string fk_MoLrn_ID, string fk_Ptrn_ID, string fk_Brn_ID, string fk_CrPrDetails_ID)
        {
            DataSet ds = new DataSet();
            //SqlParameter[] pr = new SqlParameter[4];
            Hashtable ht = new Hashtable();
            ...
            try
            {
                ...
                ds = oDB.getparamdataset("ELGV2_Fetch_REG_Student_Details_RegStu_bypassInv", ht);
                return ds;
    ...
    //				pr[1] = new SqlParameter("@pk_Institute_ID",Institute_ID);
    //				pr[2] = new SqlParameter("@pk_Student_ID",Student_ID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_Fetch_EA_Student_Details",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[1] = new SqlParameter("@pk_Institute_ID",Institute_ID);
    //				pr[2] = new SqlParameter("@pk_Student_ID",Student_ID);
    //				dr = SqlHelper.ExecuteReader(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_Fetch_EA_Student_Photo",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[1] = new SqlParameter("@pk_Institute_ID",Institute_ID);
    //				pr[2] = new SqlParameter("@pk_Student_ID",Student_ID);
    //				dr = SqlHelper.ExecuteReader(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_Fetch_EA_Student_Sign",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_Fetch_Reg_Student_Details",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //		}
        ...
        public static DataSet Reg_Fetch_Student_Photograph(int pk_Uni_ID, int pk_Year, int pk_Student_ID)
	    {
		    DataSet ds;		
		    Hashtable ht=new Hashtable();
		    DBObjectPool Pool = null;
		    ...
		    try
		    {
                ...
                ds = oDB.getparamdataset("ELGV2_Fetch_Reg_Student_Photo", ht);
			    return ds;
		    }
		    catch(Exception Ex)
		    {
        ...
        public static DataSet Reg_Fetch_Student_Signature(int pk_Uni_ID, int pk_Year, int pk_Student_ID)
	    {
		    ...
		    try
		    {
                ...
                ds = oDB.getparamdataset("ELGV2_Fetch_Reg_Student_Sign", ht);
			    return ds;
		    }
		    catch(Exception Ex)
		    {
    ...
    //				SqlHelper.ExecuteScalar(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_generatePRN_Register_IA_Student",pr);
    ...
    //				pr[5] = new SqlParameter("@ElgFormNo",SqlDbType.VarChar,50);
    //				pr[5].Direction = ParameterDirection.Output;
    //				SqlHelper.ExecuteScalar(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_generatePRN_Register_EA_Student",pr);
    //				arr[0] = pr[4].Value.ToString();
    //				arr[1] = pr[5].Value.ToString();
    //			
    //			}
    ...
    //				SqlHelper.ExecuteNonQuery(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_NonElgPendingStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //			  Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_College_CourseWiseStatistics",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //			
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"elg_GetElgPendingStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //		}
	    ...
	    public static DataSet GetAllFaculties(int UniID)
	    {
		    ...
		    try
		    {
			    ...
			    ht.Add("UniID",UniID);
			    ds = oDB.getparamdataset("ELGV2_SelectAllFaculty",ht);
			    return ds;
    ...
    //				pr[1] = new SqlParameter("@FacID",FacID);
			    ht.Add("UniID",UniID);
			    ht.Add("FacID",FacID);
			    ds = oDB.getparamdataset("ELGV2_FacultyWiseAllCourses",ht);
			    return ds;
    ...
    //				pr[2] = new SqlParameter("@CrID",CrID);
			    ...
			    ht.Add("FacID",FacID);
			    ht.Add("CrID",CrID);
			    ds = oDB.getparamdataset("ELGV2_RegularCoursePart",ht);
			    return ds;
    ...
    //				pr[2] = new SqlParameter("@CrPrID",CrPrID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_IA_CoursePartWiseStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[1] = new SqlParameter("@CrMoLrnPtrnID",CrMoLrnPtrnID);
    //				pr[2] = new SqlParameter("@CrPrID",CrPrID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_EA_CoursePartWiseStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[0] = new SqlParameter("@UniID",UniID);
    //				pr[1] = new SqlParameter("@InstID",InstID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_InstituteWiseFaculties",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_InstFacultyWiseCourses",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_InstCourseWiseCoursePart",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //			{
    //				pr[0] = new SqlParameter("@UniID",UniID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_IA_RepCourseWiseStatistics",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //			
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"Elg_IA_CollegeCoursewiseStudSummary",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //			
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_IA_CourseWiseCombinationsSummary",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				
    //				pr[0] = new SqlParameter("@UniID",UniID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_EA_RepCourseWiseStatistics",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[5] = new SqlParameter("@CrMoLrnPtrnID",CrMoLrnPtrnID);
    //			
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_EA_CourseWiseCombinationsSummary",pr);
    //			
    //			}
    //			catch(Exception Ex)
    //			{
    ...
    //			try
    //			{
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"ELG_SelectAllAcademicYears");
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"Elg_Ledger_IACourseWiseStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
    ...
    //				pr[2] = new SqlParameter("@pk_CrMoLrnPtrn_ID",CrMoLrnPtrnID);
    //				pr[3] = new SqlParameter("@pk_AcademicYr_ID",AcdYrID);
    //				ds = SqlHelper.ExecuteDataset(Classes.clsGetSettings.ConnectionString,CommandType.StoredProcedure,"Elg_Ledger_EACourseWiseStudents",pr);
    //			}
    //			catch(Exception Ex)
    //			{
    //				Exception e = new Exception(Ex.Message,Ex);
