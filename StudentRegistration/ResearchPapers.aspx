<%@ Page language="c#" Codebehind="ResearchPapers.aspx.cs" AutoEventWireup="false" Inherits="UniversityPortal.ResearchPapers" %>
								...
								<tr>
									<td vAlign="top" align="left" width="99%">
										<table>
											<tr>
												<td vAlign="top" align="left" width="99%">
													<p class="llblContentTitle" align="left">Search Research Papers
													</p>
													<P>
																...
																<TD vAlign="top" align="left" width="80%">
																	<table id="tblSelect" cellSpacing="0" cellPadding="3" width="100%" border="0" runat="server">
																		<tr>
																			...
																			<td align="left" width="69%" colSpan="1" rowSpan="1"><asp:dropdownlist id="FacID" onblur="setValue('Hid_Fac_ID',this.value)" runat="server" onchange="FillSubjects(this.value);"
																					Width="342px" CssClass="SelectBoxHome"></asp:dropdownlist><FONT class="Mandatory">*</FONT><INPUT id="Hid_Fac_ID" style="WIDTH: 37px; HEIGHT: 22px" type="hidden" size="1" name="Hid_Fac_ID"
																					runat="server"></td>
																		</tr>
																		<tr>
																			<td style="WIDTH: 255px" align="right"><b><STRONG><B>Select </B></STRONG>Subject</b></td>
																			<td style="WIDTH: 1px" width="1">&nbsp;<STRONG>:</STRONG></td>
																			<td><asp:dropdownlist id="SubID" onblur="setValue('hid_Sub_ID',this.value);" runat="server" Width="342px"
																					CssClass="SelectBoxHome"></asp:dropdownlist><FONT class="Mandatory">*</FONT><FONT class="Mandatory"></FONT><INPUT id="hid_Sub_ID" style="WIDTH: 32px; HEIGHT: 22px" type="hidden" size="1" name="hid_Sub_ID"
																					runat="server"></td>
																		</tr>
																		<TR align="center">
																			<TD style="HEIGHT: 32px" colSpan="3"><asp:button id="btnDetails" runat="server" Width="100px" CssClass="ButSp" Text="Search" Font-Bold="True"></asp:button></TD>
																		</TR>
																		<TR>
