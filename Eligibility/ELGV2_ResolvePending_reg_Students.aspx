<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" Codebehind="ELGV2_ResolvePending_reg_Students.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_ResolvePending_reg_Students" %>
        ...
        <table id="table1" style="border-collapse: collapse" bordercolor="#c0c0c0" cellpadding="2"
            ...
            <tr>
                <%--<td class="FormName" align="left" valign="middle">
                    <asp:Label ID="lblTitle" runat="server" Width="99%" Font-Bold="True" CssClass="lblPageHead">Resolve Pending Eligibility</asp:Label>--%><td align="left" style="border-bottom: 1px solid #FFD275;">
                        <asp:Label ID="lblPageHead" runat="server" Text="Resolve Pending Eligibility" ></asp:Label>
                </td>
            </tr>
            <tr>
