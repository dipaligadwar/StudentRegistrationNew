...
//zxcTO=setTimeout(1000);
  ...
  window.onscroll=Scroll;
		...
		function  fnConfirm()
		{
			...
			else if(document.getElementById('rbPending').checked == true)
			{
			   if(document.getElementById('tbReason').value == "")
			   {	
			...
			else if(document.getElementById('rbProvisional').checked == true)
			{
			   if(document.getElementById('tbReason').value == "")
			   {	
			...
			else if(document.getElementById('rbEligible').checked == true)
		...
		<form id="Form1" method="post" runat="server">
			<div align=center>
				...
				<table height="410" cellSpacing="0" cellPadding="0" width="90%" border="0">
					<TBODY>
						<tr>
							<td class="SideLeft" vAlign="top" align="left" width="18%" style="height: 1511px">
								<!--Menu Start Here-->
								<P><uc1:mainlink id="MainLink1" runat="server"></uc1:mainlink></P>
								<!--Menu Ends Here--></td>
							<td vAlign="top" align="left" width="2%" style="height: 1511px">&nbsp;</td>
							<td vAlign="top" align="left" width="80%" style="height: 1511px">
								...
								<div id="divStudentDetails" style="DISPLAY: block" runat="server"><br>
									...
									<div id="divEligibilityDecision" style="DISPLAY: block" runat="server">
										<table class="tblBackColor" id="Tbl44" cellSpacing="1" cellPadding="3" width="100%" border="0">
											<tr class="rFont">
												<td vAlign="top" width="32%" style="height: 58px"><b>Decision of Student's Eligibility</b></td>
												<td vAlign="top" style="height: 58px">
												<table width="100%"> 
												<tr>
												<td width="16%" style="height: 35px"><asp:radiobutton id="rbEligible" runat="server" Text="Eligible" GroupName="grpEligibility"></asp:radiobutton></td>
												...
												<td width="22%" style="height: 35px"><asp:radiobutton id="rbDefaulter" runat="server" Text="Not Eligible" GroupName="grpEligibility"></asp:radiobutton></td>
												<td width="30%" style="height: 35px"><asp:radiobutton id="rbPending" runat="server" Text="Eligibility Pending" GroupName="grpEligibility"></asp:radiobutton></td>
									...
									<div id="divPRN" style="DISPLAY: none" runat="server">
										<table id="Table8" cellSpacing="0" cellPadding="3" width="100%" align="center" border="0">
											<tr>
												<td align="left"><asp:label id="lblPRN" runat="server" CssClass="StylePRN"></asp:label>
                                                    &nbsp;
												</td>
											</tr>
											<tr>
											    <td align=left>
												<asp:label id="lblRefresh" Text="" runat="server" CssClass="StylePRN" style="position: relative"></asp:label></td>
											</tr>
											<tr>
											    <td align=left>
												<asp:label id="lblSMSError" Text="" runat="server" CssClass="StylePRN" style="position: relative"></asp:label></td>
											</tr>
										</table>
									</div>
									<br>
