...
{	
		sTableCellID=location;
		clsAjaxMethods.FillCoursePart(val,coursepart,BindDataToCombo_CallBackCom);
}
...
function FillAssignedConfirmedCourses(location,val,Cname)
{
	var pk_Uni_ID=document.getElementById("hidUniID").value;
	var pk_Inst_ID=document.getElementById("hidInstID").value;	
	sTableCellID=location;
	clsAjaxMethods.FillAssignedCourses(pk_Uni_ID,pk_Inst_ID,val,Cname,BindDataToCombo_CallBackCom);		
}  
function FillAssignedConfirmedCoursesPart(location,val,Cname)
{
    var pk_Uni_ID=document.getElementById("hidUniID").value;
	var pk_Inst_ID=document.getElementById("hidInstID").value;	
	sTableCellID=location;
