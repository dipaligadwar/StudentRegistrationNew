<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search_Institute.aspx.cs" Inherits="StudentRegistration.Eligibility.Search_Institute" %>
			...
			<div align=center>
				...
				<table height="48" cellSpacing="0" cellPadding="0" width="90%" border="0">
					...
					<tr height="15">
						...
						<td vAlign="top" width="40%"><asp:label id="lblTitle" runat="server" CssClass="PageHeading" Font-Bold="True" Height="8px" ForeColor="Tomato">Search Institute</asp:label>
