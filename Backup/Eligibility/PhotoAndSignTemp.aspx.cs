...
{
	/// <summary>
	/// Summary description for PhotoAndSignTemp.
	/// </summary>
	public partial class PhotoAndSignTemp : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(Request.QueryString["img"]=="PI")
			{
				...
				ds = elgDBAccess.IA_Fetch_Student_Photograph(arr[2],UniversityPortal.clsGetSettings.UniversityID.ToString(), arr[1], arr[3]);
			...
			else if(Request.QueryString["img"]=="PR")
			{
				DataSet ds;
                string[] arr = new string[4];
                arr = ElgFormNo.Split('-');  //UniID = arr[0], InstID = arr[1], Year = arr[2], StudID = arr[3]
                ds = elgDBAccess.Reg_Fetch_Student_Photograph(Convert.ToInt32(UniversityPortal.clsGetSettings.UniversityID.ToString()), Convert.ToInt32(arr[2]), Convert.ToInt32(arr[1]), Convert.ToInt32(arr[3]));
				if(ds.Tables[0].Rows.Count > 0)
				{
					byte[] Bytes=(byte[])ds.Tables[0].Rows[0]["Photograph"];
					System.IO.Stream s=new System.IO.MemoryStream(Bytes);
			...
			else if(Request.QueryString["img"]=="SI")
			{
				...
				string[] arr = new string[4];
				arr = ElgFormNo.Split('-');    //UniID = arr[0], InstID = arr[1], Year = arr[2], StudID = arr[3]
				ds = elgDBAccess.IA_Fetch_Student_Signature(arr[2],UniversityPortal.clsGetSettings.UniversityID.ToString(), arr[1], arr[3]);
				if(ds.Tables[0].Rows.Count>0)
				{
			...
			else if(Request.QueryString["img"]=="SR")
			{
				DataSet ds;
                string[] arr = new string[4];
                arr = ElgFormNo.Split('-');  //UniID = arr[0], InstID = arr[1], Year = arr[2], StudID = arr[3]
                ds = elgDBAccess.Reg_Fetch_Student_Signature(Convert.ToInt32(UniversityPortal.clsGetSettings.UniversityID.ToString()), Convert.ToInt32(arr[2]), Convert.ToInt32(arr[1]), Convert.ToInt32(arr[3]));
				if(ds.Tables[0].Rows.Count > 0)
				{
					byte[] Bytes=(byte[])ds.Tables[0].Rows[0]["Signature"];
					System.IO.Stream s=new System.IO.MemoryStream(Bytes);
			...
			if(PMatchingID != null)
			{
				...
				DataSet ds;
                ds = elgDBAccess.Reg_Fetch_Student_Photograph(Convert.ToInt32(arr[0]), Convert.ToInt32(arr[2]), Convert.ToInt32(arr[1]), Convert.ToInt32(arr[3]));
				if(ds.Tables[0].Rows.Count > 0)
				{
					byte[] Bytes=(byte[])ds.Tables[0].Rows[0]["Photograph"];
					System.IO.Stream s=new System.IO.MemoryStream(Bytes);
			...
			if(SMatchingID != null)
			{
				...
				DataSet ds;
                ds = elgDBAccess.Reg_Fetch_Student_Signature(Convert.ToInt32(arr[0]), Convert.ToInt32(arr[2]), Convert.ToInt32(arr[1]), Convert.ToInt32(arr[3]));
				if(ds.Tables[0].Rows.Count > 0)
				{
					byte[] Bytes=(byte[])ds.Tables[0].Rows[0]["Signature"];
					System.IO.Stream s=new System.IO.MemoryStream(Bytes);
