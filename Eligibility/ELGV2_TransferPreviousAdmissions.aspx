<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" CodeBehind="ELGV2_TransferPreviousAdmissions.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_TransferPreviousAdmissions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="left" id="PageTitleHolder">
        <asp:Label ID="lblPageHead" runat="server" Text="College Transfer" />
                ...
                <tr>
                    <td>
                        <div align="right" class="clLeft" style="height: 25px; padding-top: 12px; width: 180px;">
                            <asp:Label ID="lblPRN" runat="server" Text="DU PRN" meta:resourcekey="lblPRNResource1"></asp:Label><b>
                                : </b>
                        </div>
    ...
    <div id="divDisplayData" width="700px" runat="server" style="display: none">
        <asp:GridView runat="server" AutoGenerateColumns="False" ID="GV_SrchStud" Width="100%"
            AllowSorting="True" OnRowCommand="GV_SrchStud_RowCommand" DataKeyNames="Student_Name"
            CssClass="clGrid" meta:resourcekey="GV_SrchStudResource1" EnableModelValidation="True">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="course_name" HeaderText="Course Name" meta:resourcekey="BoundFieldResource1">
                    <HeaderStyle Width="40%" CssClass="gridHeader"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Crpr_Abbr" HeaderText="Part" meta:resourcekey="BoundFieldResource2">
                    <HeaderStyle Width="10%" CssClass="gridHeader"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="CrPrCh_Abbr" HeaderText="Part Term" meta:resourcekey="BoundFieldResource3">
                    <HeaderStyle Width="10%" CssClass="gridHeader"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Academic Year" HeaderText="Academic Year" meta:resourcekey="BoundFieldResource4">
                    <HeaderStyle Width="10%" CssClass="gridHeader"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Inst_Code" HeaderText="College Code" meta:resourcekey="BoundFieldResource5">
                    <HeaderStyle Width="10%" CssClass="gridHeader"></HeaderStyle>
                </asp:BoundField>
                <asp:TemplateField HeaderText="Transfer College" meta:resourcekey="TemplateFieldResource1">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkSelect" Text="Transfer" ForeColor="Blue" runat="server" CommandName="Select"
                            CommandArgument='<%# Container.DisplayIndex %>' OnClientClick="return SetInstitute();"
