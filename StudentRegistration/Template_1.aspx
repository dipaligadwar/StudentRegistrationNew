					...
					<tr>
						<td colspan="5" height="10">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" width="900"
								...
								<tr>
									<td colspan="3" align="left" height="35" background='Templates/template_1/linkbg.gif'
										valign='bottom'>
										<!--
								...
								<tr height="5">
									<td background='Templates/template_1/middlespacer.gif'><img src='Templates/template_1/left-corner.gif'></td>
									<td background='Templates/template_1/middlespacer.gif' width="99%"></td>
									<td background='Templates/template_1/middlespacer.gif' align="right" valign="bottom"><img src='Templates/template_1/right-corner.gif'></td>
								</tr>
							</table>
							<!-- End :Header -->
						</td>
						...
						<td valign="top" align="center" width="558" height="380">
							<table width="100%" cellpadding="1" cellspacing="1">
								<tbody>
									<tr>
										<td>
											<asp:literal id="C20" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td>
											<asp:literal id="C13" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
											<asp:literal id="C7" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
											<asp:literal id="C8" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
											<asp:literal id="C9" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
											<asp:literal id="C14" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td>
