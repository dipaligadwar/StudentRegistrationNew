...
{
    public partial class reg_ResolveProvisionalEligibility : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            RegStudentAdvancedSearchCtrl.StrUrl = "reg_ResolveProvisionalEligibility__1.aspx?Search=Adv";
            ...
            if (cnt == 3)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows[0]["Eligibility"].ToString() == "3")    // Pending Eligibility
                    {
                        ...
                        Server.Transfer("reg_ResolveProvisionalEligibility__1.aspx?Search=Simple");
                    }
