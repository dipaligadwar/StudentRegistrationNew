<%@ Page language="c#" Codebehind="frmDistrictWiseColleges.aspx.cs" AutoEventWireup="false" Inherits="UniversityPortal.frmDistrictWiseCourses" %>
...
<HTML>
	<HEAD>
		...
		{	
			...
			{
				  var url="frmDistrictWiseColleges_print.aspx?Dist_ID="+sDist_ID+"&Dist_Name="+sDist_Name;
		...
		<form id="Form1" method="post" runat="server">
			<p style="MARGIN: 0px" align="center">
				<table style="BORDER-COLLAPSE: collapse" borderColor="#c0c0c0" cellPadding="2" width="900"
						...
						<td vAlign="top" width="830" height="450">
							...
							<table id="tblLocation" style="DISPLAY: inline" cellSpacing="0" cellPadding="0" width="100%"
								...
								<tr>
									...
									<td width="69%"><asp:dropdownlist id="State_ID" runat="server" CssClass="selectBoxHome" Width="206px" onChange="setValue('hidStateID',this.value);FillDistricts(this.value,'E','District_ID');"></asp:dropdownlist><INPUT id="hidStateID" style="WIDTH: 35px; HEIGHT: 22px" type="hidden" size="1" runat="server"></td>
								</tr>
								<tr>
									<td align="right" width="35%"><B>Select District</B></td>
									<td align="center" width="1%"><B>:</B></td>
									<td width="69%"><asp:dropdownlist id="District_ID" runat="server" CssClass="selectBoxHome" Width="206px" onChange="setValue('hidDistID',this.value);"></asp:dropdownlist><INPUT id="hidDistID" style="WIDTH: 35px; HEIGHT: 22px" type="hidden" size="1" runat="server"></td>
								</tr>
							</table>
					...
					<tr>
						<td colSpan="3"><INPUT id="hidUniID" style="WIDTH: 41px; HEIGHT: 22px" type="hidden" size="1" runat="server"></td>
					</tr>
					<tr>
