<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ELGV2_BulkProcess__2.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_BulkProcess__2" Culture="auto"
                                ...
                                <div id="divStudentStatusDetails" runat="server">
                                    ...
                                    <table class="tblBackColor" id="TblAdmission" style="display: none" cellspacing="1"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="rFont">
                                                <td width="30%">
                                                    <b><asp:Label ID="CollegeName" runat="server" Text="College Name" meta:resourcekey="CollegeNameResource1"></asp:Label></b></td>
                                    ...
                                    <div id="divMatchingRecords" style="display: none" runat="server">
                                        <asp:Label ID="lblGridName" runat="server" Height="18px" CssClass="GridHeadingM"
                                            Width="100%" Text="Other Course Eligibility Status" meta:resourcekey="lblGridNameResource1"></asp:Label>
                                        <asp:GridView ID="DGMatchgCourseDetails1" runat="server" Width="100%" BorderStyle="Solid"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Course" HeaderText="Course" meta:resourcekey="BoundFieldResource2">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="InstituteName" HeaderText="College Name" meta:resourcekey="BoundFieldResource3">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="EligibilityStatus" HeaderText="Eligibility Status" meta:resourcekey="BoundFieldResource4">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="CourseStatus" HeaderText="Course Status" meta:resourcekey="BoundFieldResource5">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Reason" HeaderText="Reason" meta:resourcekey="BoundFieldResource6">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ElgFormNo" HeaderText="Eligibility Form Number" meta:resourcekey="BoundFieldResource7">
                                                    <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                </asp:BoundField>
                                            </Columns>
                                            ...
                                            <td>
                                                <asp:GridView ID="DGQualification1" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CollegeInstituteName" HeaderText="College" meta:resourcekey="BoundFieldResource16">
                                                            <HeaderStyle Font-Bold="True" CssClass="gridHeader" HorizontalAlign="Center"></HeaderStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Body" HeaderText="University" meta:resourcekey="BoundFieldResource17">
                                                            <HeaderStyle Font-Bold="True" CssClass="gridHeader" HorizontalAlign="Center"></HeaderStyle>
                                                        </asp:BoundField>
                                            ...
                                            <td valign="top" align="center" width="100%">
                                                <asp:GridView ID="DGSubmittedDocs1" runat="server" Width="90%" BorderStyle="Solid"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="DocCert_Desc" ReadOnly="True" HeaderText="Document Name" meta:resourcekey="BoundFieldResource1">
                                                            <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="pk_DocCert_ID" ReadOnly="True" HeaderText="Doc_ID" meta:resourcekey="BoundFieldResource9"></asp:BoundField>
                                                    </Columns>
                                                    <PagerStyle VerticalAlign="Middle" Font-Bold="True" HorizontalAlign="Right" BackColor="Control">
                                                    </PagerStyle>
                                                </asp:GridView>
