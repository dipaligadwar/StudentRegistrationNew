<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg_ResolveProvisionalEligibility__1.aspx.cs" Inherits="StudentRegistration.Eligibility.reg_ResolveProvisionalEligibility__1" %>
						...
						<tr>
							...
							<td vAlign="top" align="left" width="80%">
								<div id="divPendingReason" style="DISPLAY: block" runat="server"><asp:label id="lblEligibilityReason" runat="server" Width="100%" CssClass="GridHeadingM" Font-Bold="True"
										text="Eligibility Kept Provisional due to following reason(s)"></asp:label>
									<table class="tblBackColor" id="Tbl1" cellSpacing="1" cellPadding="3" width="100%" border="0">
										<TBODY>
											<tr class="rFont">
												<td><asp:label id="lblProvisionalReason" runat="server" CssClass="lblreason" Font-Bold="True"></asp:label></td>
											</tr>
										</TBODY>
									</table>
								</div>
								...
								<div id="divStudentDetails" style="DISPLAY: none" runat="server"><br>
									<asp:label id="lblProfileHeading" runat="server" Width="100%" CssClass="GridHeadingM" Height="18px">Provisionally Eligible Student's Profile</asp:label><br>
									<br>
									...
									<div id="divInstructions" style="BORDER-RIGHT: green solid; BORDER-TOP: green solid; DISPLAY: none; BORDER-LEFT: green solid; WIDTH: 300px; BORDER-BOTTOM: green solid; POSITION: absolute; HEIGHT: 200px; BACKGROUND-COLOR: white"
										...
										<table onmousedown="dragStart(event, 'divInstructions')" style="CURSOR: move; BACKGROUND-COLOR: green"
											...
											<tr>
												<td class="GridHeadingMI" width="100%"><asp:label id="lblInstructionHead" runat="server" Height="18px">Instructions for Provisional Eligibility Decision</asp:label></td>
											...
											<ol>
												<li>
													<font color="black">Please view the displayed profile of the student whose 
														Provisional Eligibility is under consideration.<br>
														<br>
													</font>
												<li>
												...
												<li>
													<font color="black">Take the eligibility decision by marking 'Eligible' / 'Not 
														Eligible' / 'Pending Eligible' / 'Provisionally Eligible'.</font><br>
													<br>
												<li>
													<font color="black">Take the eligibility decision by marking 'Eligible' / 'Not 
														Eligible' / 'Pending Eligible' / 'Provisionally Eligible'.</font><br>
									...
									<div id="divEligibilityDecision" style="DISPLAY: block" runat="server">
										<table class="tblBackColor" id="Tbl44" cellSpacing="1" cellPadding="3" width="100%" border="0">
											<tr class="rFont">
												...
												<table width="100%"> 
												<tr>
												<td width="25%" style="height: 35px"><asp:radiobutton id="rbEligible" runat="server" Text="Eligible" GroupName="grpEligibility"></asp:radiobutton></td>
												<td width="45%" style="height: 35px"><asp:radiobutton id="rbProvisional" runat="server" Text="Provisionally Eligible" GroupName="grpEligibility"></asp:radiobutton></td> 
												<td width="30%" style="height: 35px"><asp:radiobutton id="rbDefaulter" runat="server" Text="Not Eligible" GroupName="grpEligibility"></asp:radiobutton></td>
