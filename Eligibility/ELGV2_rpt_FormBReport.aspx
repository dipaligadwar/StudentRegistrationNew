<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true"
    CodeBehind="ELGV2_rpt_FormBReport.aspx.cs" Inherits="StudentRegistration.Eligibility.ELGV2_rpt_FormBReport" %>
    ...
    <table id="table1" style="border-collapse: collapse" bordercolor="#c0c0c0" cellpadding="2"
        ...
        <tr style="width: 700">
            <td class="FormName" align="left" width="100%">
                <asp:Label ID="lblPageHead" runat="server" Font-Bold="True" Text="Form B Report"></asp:Label>
