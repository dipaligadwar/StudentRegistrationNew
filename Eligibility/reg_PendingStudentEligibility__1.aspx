		...
		function fnOnSubmit()
		{
			...
			for(var i=1;i<=cnt;i++)
			{
				if(document.getElementById('DGSubmittedDocs').cells[((i+1)*5)-2].childNodes[0].checked == true)
				{
					...
					var arrRadio = document.getElementById('DGSubmittedDocs').getElementsByTagName("INPUT");
					for(i=0;i<arrRadio.length;i++)
					{
					    if(arrRadio[i].type=='radio' && arrRadio[i].checked)
					    {
					        if(arrRadio[i].value=="rbValidDoc")
					        {
					           DocXML.value = DocXML.value + "1";   //Validity_By_Uni = 1 
					        }
					        else if(arrRadio[i].value=="rbInvalidDoc")
					        {
									...
									<div id="divEligibilityDecision" style="DISPLAY: block" runat="server">
										<table class="tblBackColor" id="Tbl44" cellSpacing="1" cellPadding="3" width="100%" border="0">
											<tr class="rFont">
												...
												<td vAlign="top"><asp:radiobutton id="rbEligible" runat="server" GroupName="grpEligibility" Text="Eligible"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<asp:radiobutton id="rbDefaulter" runat="server" GroupName="grpEligibility" Text="Not Eligible"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<asp:radiobutton id="rbPending" runat="server" GroupName="grpEligibility" Text="Eligibility Pending"></asp:radiobutton></td>
											</tr>
										</table>
