<%@ Page language="c#" Codebehind="frmDistrictWiseColleges_print.aspx.cs" AutoEventWireup="false" Inherits="UniversityPortal.frmDistrictWiseColleges_print" %>
							...
							<asp:DataGrid id="dgData" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="1px"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="Inst_Name" HeaderText="College Name">
										<HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="30%" VerticalAlign="Middle"></HeaderStyle>
										<ItemStyle Font-Size="8pt" HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="ParBdy_Name" HeaderText="Parent Body">
										<HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="20%" VerticalAlign="Middle"></HeaderStyle>
										<ItemStyle Font-Size="8pt" HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
