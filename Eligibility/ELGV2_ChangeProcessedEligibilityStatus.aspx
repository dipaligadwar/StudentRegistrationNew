<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ELGV2_ChangeProcessedEligibilityStatus.aspx.cs" MasterPageFile="~/Home.Master" Inherits="StudentRegistration.Eligibility.ELGV2_ChangeProcessedEligibilityStatus" %>

<%@ Register Src="WebCtrl/searchInstNewChangeElgUnprocess.ascx" TagName="SchInst" TagPrefix="uc2" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblUserControl">
                            <tr>
                                <td valign="top" align="center" style="width: 80%">
                                    <uc2:SchInst ID="SchInst12" runat="server" />
                                </td>
                            </tr>
                        </table>
