<%@ Control Language="C#" AutoEventWireup="true" Codebehind="searchInstNewChangeElgUnprocess.ascx.cs"
    Inherits="StudentRegistration.Eligibility.searchInstNewChangeElgUnprocess" %>
...
<fieldset id="fldPapers" runat="server" style="display: none; width: 90%" align="center">
    ...
    <p style="margin-top: 0px; margin-bottom: 0px; margin-left: 0px" align="center">
        <asp:GridView ID="dgData1" runat="server" Width="95%" AutoGenerateColumns="False" CssClass="clGrid grid-view"
            AllowPaging="True" PageSize="25"   OnPageIndexChanging="dgData1_PageIndexChanging" OnRowCommand="dgData1_RowCommand" OnRowDataBound="dgData1_RowDataBound">
