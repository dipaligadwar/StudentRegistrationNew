<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectSingleCourseExamEvent.ascx.cs" Inherits="StudentRegistration.Eligibility.WebCtrl.SelectSingleCourseExamEvent" %>
...
<script language="javascript" type="text/javascript">
	...
	function fnValidate( ctrlToValidate )
	{
		...
		if ( document.getElementById( "<%=hidSelectedRadio.ClientID%>" ).value == "A" )
		{
			myArr[myArr.length] = new Array( document.getElementById( "<%=ddlAcadYear.ClientID%>" ), "0", "Select Academic Year.", "select" );
		}
		else if ( document.getElementById( "<%=hidSelectedRadio.ClientID%>" ).value == "E" )
		{
			myArr[myArr.length] = new Array( document.getElementById( "<%=ddlExEvent.ClientID%>" ), "0", "Select Exam Event.", "select" );
		}
		...
		if ( document.getElementById( "<%=isPpChange.ClientID%>" ).value == 'Yes' )
		{
			...
			if ( ( obPRN.length == 0 ) && ( obElg.length == 0 ) )
			{
				...
				myArr[myArr.length] = new Array( document.getElementById( "<%= hidSSVal.ClientID%>" ), "Empty", "Please Enter a valid " + document.getElementById( 'ctl00_ContentPlaceHolder1_lblPRNNomenclature' ).innerText + " OR Eligibility Form Number.", "text" );
...
<div id="ControlHolder">
	...
	<div>
		<div>
			<input type="radio" id="rdAcademicYr" name="rdFilter" onclick="ToggleControls('A');" checked="checked" />Academic Year Wise
			<input type="radio" id="rdExamEvent" name="rdFilter" onclick="ToggleControls('E');" />Exam Event Wise
		</div>
		<div id="divAcadYear" style="width: 700px; clear: both;" runat="server">
			...
			<div align="left" style="padding: 3px" class="clLeft">
				<asp:DropDownList ID="ddlAcadYear" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAcadYear_SelectedIndexChanged" meta:resourcekey="ddlAcadYearResource1">
		...
		<div id="divExEvent" style="width: 700px; clear: both; display: none" runat="server">
			<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
				Exam Event<b> : </b>
			</div>
			<div align="left" style="padding: 3px" class="clLeft">
				<asp:DropDownList ID="ddlExEvent" Width="420px" runat="server" meta:resourcekey="ddlExEventResource1">
					<asp:ListItem Value="0" meta:resourcekey="ListItemResource2">---- Select ----</asp:ListItem>
				</asp:DropDownList>
				&nbsp;<font class="Mandatory">*</font></div>
			<input type="hidden" runat="server" id="hid_ExEv1" />
			<input type="hidden" runat="server" id="hid_ExEv2" />
		</div>
			...
			<ContentTemplate>
				<div id="divRegionalCenter" runat="server">
					<div style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px; width: 420px" class="clLeft">
							<asp:RadioButton ID="ChkAllRegionalCenter" runat="server" Width="205px" AutoPostBack="True" onclick="ShowHide();" OnCheckedChanged="ChkAllRegionalCenter_CheckedChanged" Text="All Regional Center" GroupName="grpRegionalCenter" Checked="True" meta:resourcekey="ChkAllRegionalCenterResource1"></asp:RadioButton>
							<asp:RadioButton ID="ChkSelectedRegionalCenter" runat="server" Width="205px" onclick="ShowHide();" Text="Selected Regional Center" GroupName="grpRegionalCenter" meta:resourcekey="ChkSelectedRegionalCenterResource1"></asp:RadioButton>
						</div>
					</div>
					<div id="dvSelectRC" runat="server" style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px" class="clLeft">
							<asp:DropDownList ID="ddlRegionalCenter" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlRegionalCenter_SelectedIndexChanged" meta:resourcekey="ddlRegionalCenterResource1">
								<asp:ListItem Value="0" meta:resourcekey="ListItemResource2">---- Select ----</asp:ListItem>
							</asp:DropDownList>
				...
				<div id="divStudyCenter" runat="server">
					<div style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px; width: 420px" class="clLeft">
							<asp:RadioButton ID="ChkAllStudyCenter" runat="server" Width="205px" AutoPostBack="True" onclick="ShowHide();" OnCheckedChanged="ChkAllStudyCenter_CheckedChanged" Text="All Institutes" GroupName="grpStudyCenter" Checked="true" meta:resourcekey="ChkAllStudyCenterResource1"></asp:RadioButton>
							<asp:RadioButton ID="ChkSelectedStudyCenter" runat="server" Width="205px" AutoPostBack="True" onclick="ShowHide();" OnCheckedChanged="ChkSelectedStudyCenter_CheckedChanged" Text="Selected Institute" GroupName="grpStudyCenter" meta:resourcekey="ChkSelectedStudyCenterResource1"></asp:RadioButton>
						</div>
					</div>
					<div id="dvSelectSC" runat="server" style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px" class="clLeft">
							<asp:TextBox ID="txtCenterCode" runat="server" Width="80px" onchange="SetInstitute();" meta:resourcekey="txtCenterCodeResource1" />&nbsp;&nbsp;
							<asp:DropDownList ID="ddlStudyCenter" Width="324px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlStudyCenter_SelectedIndexChanged" meta:resourcekey="ddlStudyCenterResource1">
								<asp:ListItem Value="0" meta:resourcekey="ListItemResource3">---- Select ----</asp:ListItem>
							</asp:DropDownList>
							&nbsp;<font class="Mandatory">*</font>
						</div>
						<cc1:TextBoxWatermarkExtender ID="TBWE2" runat="server" TargetControlID="txtCenterCode" WatermarkText=" Enter Code" WatermarkCssClass="WaterMark" Enabled="True" />
					</div>
				</div>
				<div id="divFaculty" runat="server" style="width: 700px; clear: both;">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblFac" runat="server" Text="Faculty" meta:resourcekey="lblFacResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px" class="clLeft">
						<asp:DropDownList ID="ddlFaculty" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFaculty_SelectedIndexChanged" meta:resourcekey="ddlFacultyResource1">
						</asp:DropDownList>
						&nbsp;<font class="Mandatory">*</font></div>
				</div>
				<div id="divCourse" runat="server" style="width: 700px; clear: both;">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblCourse" runat="server" Text="Course Name" meta:resourcekey="lblCourseResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px" class="clLeft">
						<asp:DropDownList ID="ddlCourse" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" meta:resourcekey="ddlCourseResource1">
				...
				<div id="divBranch" runat="server" style="width: 700px; clear: both;">
					...
					<div align="left" style="padding: 3px" class="clLeft">
						<asp:DropDownList ID="ddlBranch" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged" meta:resourcekey="ddlBranchResource1">
				...
				<div id="divPart" style="width: 700px; clear: both;" runat="server">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblPart" runat="server" Text="Course Part Details" meta:resourcekey="lblPartResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px" class="clLeft">
						<asp:DropDownList ID="ddlPart" Width="420px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPart_SelectedIndexChanged" meta:resourcekey="ddlPartResource1">
				...
				<div id="divTerm" style="width: 700px; clear: both;" runat="server">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblTerm" runat="server" Text="Course Part Term" meta:resourcekey="lblTermResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px" class="clLeft">
				...
				<div id="divDiscTerms" style="width: 700px; clear: both; display: none" runat="server">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right" id="trCrPrChoice" runat="server">
					...
					<div align="left" style="padding: 3px" class="clLeft" id="trTerm" runat="server">
						<asp:CheckBoxList ID="chkChild" runat="server" Width="100%" RepeatDirection="Horizontal" meta:resourcekey="chkChildResource1">
						</asp:CheckBoxList>
					</div>
				</div>
				<div id="divReportDisp" runat="server">
					<div style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px; width: 420px" class="clLeft">
							<asp:RadioButton ID="rdbtnUser" runat="server" Width="205px" AutoPostBack="True" OnCheckedChanged="rdbtnUser_CheckedChanged" Text="Data Entry User" GroupName="grpReportDisp" Checked="True" meta:resourcekey="rdbtnUserResource1"></asp:RadioButton>
							<asp:RadioButton ID="rdbtnDate" runat="server" Width="205px" AutoPostBack="True" OnCheckedChanged="rdbtnDate_CheckedChanged" Text="Date Range" GroupName="grpReportDisp" meta:resourcekey="rdbtnDateResource1"></asp:RadioButton>
						</div>
					</div>
					...
					<div id="DivDate" runat="server" style="width: 700px; clear: both;">
						...
						<div align="left" style="padding: 3px; width: 420px" class="clLeft">
							...
							<div class="clLeft">
								<asp:TextBox ID="txtFrom" runat="server" MaxLength="10" AutoCompleteType="Disabled" Width="80px" meta:resourcekey="txtFromResource1" />
								<font class="Mandatory">*</font>
							</div>
							...
							<div class="clLeft">
								<asp:TextBox ID="txtTo" runat="server" MaxLength="10" AutoCompleteType="Disabled" Width="80px" meta:resourcekey="txtToResource1" />
								<font class="Mandatory">*</font>&nbsp;&nbsp;[dd/mm/yyyy]
							</div>
						</div>
						<cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtFrom" Mask="99/99/9999" MaskType="Date" ErrorTooltipEnabled="True" CultureName="en-GB" CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="&#163;" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="." CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True" />
						<cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFrom" Format="dd/MM/yyyy" Enabled="True" />
						<cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" TargetControlID="txtTo" Mask="99/99/9999" MaskType="Date" ErrorTooltipEnabled="True" CultureName="en-GB" CultureAMPMPlaceholder="AM;PM" CultureCurrencySymbolPlaceholder="&#163;" CultureDateFormat="DMY" CultureDatePlaceholder="/" CultureDecimalPlaceholder="." CultureThousandsPlaceholder="," CultureTimePlaceholder=":" Enabled="True" />
						<cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtTo" Format="dd/MM/yyyy" Enabled="True" />
					</div>
				</div>
				<div id="divPRN" runat="server" style="width: 700px; clear: both; display: none">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblPRN" runat="server" Text="PRN" meta:resourcekey="lblPRNResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px; width: 420px" class="clLeft">
						<asp:TextBox ID="txtPRN" runat="server" onclick="this.value='';" meta:resourcekey="txtPRNResource1"></asp:TextBox>&nbsp;<font class="Mandatory">*</font></div>
				</div>
				...
				<div id="divElgFormNo" runat="server" style="width: 700px; clear: both; display: none">
					<div style="width: 180px; padding: 5px;" class="clLeft" align="right">
						<asp:Label ID="lblElgFormNo" runat="server" Text="Eligibility Form No." meta:resourcekey="lblElgFormNoResource1" /><b> : </b>
					</div>
					<div align="left" style="padding: 3px" class="clLeft">
						<asp:TextBox ID="txtElgFormNo" runat="server" AutoPostBack="True" onclick="this.value='';" meta:resourcekey="txtElgFormNoResource1"></asp:TextBox>&nbsp;<font class="Mandatory">*</font></div>
				</div>
				<input id="hidFacID" runat="server" size="1" type="hidden" />
				</input> </input>
				<input id="hidCrID" runat="server" size="1" type="hidden"></input>
				</input>
				<input id="hidMoLrnID" runat="server" size="1" type="hidden"></input>
				</input>
				<input id="hidPtrnID" runat="server" size="1" type="hidden"></input>
				</input>
				<input id="hidBrnID" runat="server" size="1" type="hidden"></input>
				</input>
				<input id="hidUniID" runat="server" type="hidden"></input>
	...
	<div align="center" class="clButtonHolder" style="clear: both; padding-top: 5px;">
		<asp:Button ID="btnProceed" runat="server" Text="Proceed" OnClientClick="return fnValidate(this);" OnClick="btnProceed_Click" meta:resourcekey="btnProceedResource1" />
	</div>
	<br />
	...
	<asp:Label ID="lblNomenclatureCourse" runat="server" Text="Course" Style="display: none" meta:resourcekey="lblNomenclatureCourseResource1"></asp:Label>
	<asp:Label ID="lblSelectCr" runat="server" Text="Course" meta:resourcekey="lblSelectCrResource1" Style="display: none"></asp:Label>
	...
	<input id="hidSelectedRadio" type="hidden" runat="server" value="A" />
	<input type="hidden" runat="server" id="hidCenterType" />
</div>
<script type="text/javascript">
	function ToggleControls( control )
	{
		if ( control == 'A' )
		{
			document.getElementById( '<%=divExEvent.ClientID%>' ).style.display = "none";
			document.getElementById( '<%=divAcadYear.ClientID%>' ).style.display = "block";
			document.getElementById( '<%=hidSelectedRadio.ClientID %>' ).value = 'A';
			//			document.getElementById('<%=divRegionalCenter.ClientID%>').style.display = "block";
			document.getElementById( '<%=divStudyCenter.ClientID%>' ).style.display = "block";
		}
		else
		{
			document.getElementById( '<%=divExEvent.ClientID%>' ).style.display = "block";
			document.getElementById( '<%=divAcadYear.ClientID%>' ).style.display = "none";
			document.getElementById( '<%=hidSelectedRadio.ClientID %>' ).value = 'E';
			//			document.getElementById('<%=divRegionalCenter.ClientID%>').style.display = "none";
			document.getElementById( '<%=divStudyCenter.ClientID%>' ).style.display = "none";
		}
	}
</script>
