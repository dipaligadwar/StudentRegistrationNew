				...
				<table id="tblDGElgRegular" style="DISPLAY: none" width="100%" runat="server">
					<TR>
						<td><asp:datagrid id="dgElgRegular" runat="server" Width="100%" BorderWidth="1px" BorderStyle="Solid"
								AllowPaging="True" BorderColor="#336699" AutoGenerateColumns="False" OnItemDataBound="dgElgRegular_ItemDataBound" OnItemCommand="dgElgRegular_ItemCommand" OnPageIndexChanged="dgElgRegular_PageIndexChanged">
