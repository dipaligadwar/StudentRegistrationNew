<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" Codebehind="ELGV2_rptViewStatus_MUHS.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_rptViewStatus_MUHS" %>
		       ...
		       try { 
	            ...
	            myArr[++i]  = new Array(document.getElementById("<%=ddlCrDesc.ClientID%>"),-1,"Please Select "+document.getElementById('<%=lblCr.ClientID%>').innerText,"select"); 
                    ...
                    if(document.getElementById("<%=divCollege.ClientID%>").style.display!='none')
                    {
		                ...
		                var chkCriterion = document.getElementById("<%=cblEligibilityStatus.ClientID%>").getElementsByTagName("input");                                        
                        var oChecked=false;
                        document.getElementById("<%=hidTermSelection.ClientID%>").value="";
                         for (var j = 0; j < chkCriterion.length; j++)
                         {
                                if(chkCriterion[j].checked)
                                {
                                    oChecked=true;
                                    break;
                                }                            
                                ...
                                <table runat="server" id="Table2" style="margin-left: 30px; width: 90%; azimuth: center">
                                    <tr runat="server" id="Tr1">
                                        <td runat="server" id="Td2">
                                            ...
                                            <table cellspacing="0" cellpadding="2" width="110%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="vertical-align: top; width: 220px; padding-top: 11px" align="right">
                                                            <asp:Label runat="server" Text="Include Criteria" Font-Bold="True" ID="Label1"></asp:Label>
                                                        </td>
                                                        <td style="vertical-align: top; width: 1%; padding-top: 11px; height: 20px" align="right">
                                                            <b>&nbsp;:&nbsp;</b></td>
                                                        <td style="vertical-align: top; height: 20px" align="left">
                                                            <%--<asp:CheckBoxList runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="390px"
                                                                ID="cblEligibilityStatus" meta:resourceKey="cblEligibilityStatusResource1">
                                                                <asp:ListItem Selected="True" Text="Eligible Students" Value="1" meta:resourceKey="ListItemResource7"></asp:ListItem>
                                                                <asp:ListItem Text="Provisionally Eligible Students" Value="5" meta:resourceKey="ListItemResource8"></asp:ListItem>
                                                                <asp:ListItem Text="Not Eligible Students" Value="2" meta:resourceKey="ListItemResource9"></asp:ListItem>
                                                                <asp:ListItem Text="Student Having Eligibility Pending" Value="3" meta:resourceKey="ListItemResource10"></asp:ListItem>
                                                                <asp:ListItem Text="Students Not Yet Processed" Value="4" meta:resourceKey="ListItemResource11"></asp:ListItem>
                                                                <asp:ListItem Text="Include Students whose Eligibility is not required to be processed for this Course Part Term" Value="6" meta:resourceKey="ListItemResource111"></asp:ListItem>
                                                            </asp:CheckBoxList>--%>
                                                            <asp:RadioButtonList runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="390px"
                                                                ID="cblEligibilityStatus">                                                                
                                                                <asp:ListItem Selected="True" Text="Eligible Students" Value="1" meta:resourceKey="ListItemResource7"></asp:ListItem>
                                                                <asp:ListItem Text="Provisionally Eligible Students" Value="5" meta:resourceKey="ListItemResource8"></asp:ListItem>
                                                                <asp:ListItem Text="Not Eligible Students" Value="2" meta:resourceKey="ListItemResource9"></asp:ListItem>
                                                                <asp:ListItem Text="Student Having Eligibility Pending" Value="3" meta:resourceKey="ListItemResource10"></asp:ListItem>
                                            ...
                                            <tr>
                                                <td style="height: 18px" valign="middle" align="center" colspan="4">
                                                    <asp:Button runat="server" OnClientClick="return callvalidate();" Text="Generate Report"
                                                        CssClass="butSubmit" ID="btnDisplay" meta:resourceKey="btnDisplayResource1" OnClick="btnDisplay_Click">
                                                    </asp:Button>
                                                    &nbsp;
                                                </td>
                                            </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 641px; height: 15px; text-align: left">
                                                            <asp:Label runat="server" ID="lblnorecordfound" Style="display: none" meta:resourceKey="lblnorecordfoundResource1"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <div runat="server" id="divDGEligibility" style="display: none; margin-left: 2px;
                                                width: 100%; position: relative; border-collapse: collapse">
                                                <table runat="server" id="tblDGEligibility">
                                                    <tr runat="server">
                                                        <td runat="server">
                                                            <table runat="server" id="btnBackDisplay" width="100%">
                                                                <tr runat="server">
                                                                    <td runat="server" valign="middle" align="right" colspan="4">
                                                                    ...
                                                                    <td runat="server" align="left">
                                                                        <asp:Button runat="server" Text="Export to PDF" CssClass="butSubmit" ID="btnGenerate"
                                                                            meta:resourceKey="btnGenerateResource1" OnClick="btnGenerate_Click"></asp:Button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br />
                                                            <asp:GridView runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                                                PageSize="25" BorderStyle="None" CssClass="clGrid grid-view" Width="100%" ID="DGEligibility1"
                                                                Style="border-top-style: double; border-right-style: double; border-left-style: double;
                                                                border-collapse: collapse; border-bottom-style: double" meta:resourceKey="DGEligibilityResource1"
                                                                OnPageIndexChanging="DGEligibility1_PageIndexChanging" DataKeyNames="Eligibility_Required"  
                                                                OnSorting="DGEligibility1_Sorting" onrowdatabound="DGEligibility1_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="StudentName" HeaderText="Student Name as appeared on Statement of Marks"
                                                                        SortExpression="StudentName">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="22%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                     <asp:BoundField DataField="CETType_Desc" HeaderText="Criteria"
                                                                        ReadOnly="True" SortExpression="CETType_Desc">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="17%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Admission_Date" HeaderText="Admission Date"
                                                                        ReadOnly="True" SortExpression="Admission_Date">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="17%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                     ...
                                                                     <asp:BoundField DataField="QuotaType_Desc" HeaderText="Quota"
                                                                        ReadOnly="True" SortExpression="QuotaType_Desc">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="17%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                     <asp:BoundField DataField="EligibilityStatus" HeaderText="Eligibility Status" SortExpression="EligibilityStatus"
                                                                        meta:resourceKey="BoundFieldResource4">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="clOff"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" CssClass="clOff" Width="15%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                   <%-- <asp:BoundField DataField="Eligibility_Form_No" HeaderText="Eligibility Form No."
                                                                        ReadOnly="True" SortExpression="Eligibility_Form_No" meta:resourceKey="BoundFieldResource2">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="17%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="Elg_Processed_By" HeaderText="User Name">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Elg_Processed_On" HeaderText="Date & Time Stamp">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="gridHeader"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                                                                    </asp:BoundField>--%>
                                                                </Columns>
                                                                <HeaderStyle CssClass="gridHeader"></HeaderStyle>
                                                                <PagerStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="True"></PagerStyle>
