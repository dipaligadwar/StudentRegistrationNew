<%@ Page language="c#" Codebehind="frmFacultyWiseColleges.aspx.cs" AutoEventWireup="false" Inherits="UniversityPortal.frmFacultyWiseColleges" %>
...
<HTML>
	<HEAD>
		...
		{	
			...
			//var sFac_Desc=document.getElementById("Faculty_ID").options[document.getElementById("Faculty_ID").selectedIndex].text;
			if(sFac_ID!="" && sFac_ID!=null)
			{
				  var url="frmFacultyWiseColleges_print.aspx?Fac_ID="+sFac_ID;
