...
{
    public partial class reg_ResolveProvisionalEligibility__1 : System.Web.UI.Page
    {
        /// <summary>
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (hidInstID.Value != "" && hidInstID.Value != null)
            {
                ...
                lblTitle.Text = "Resolve Provisional Eligibility";
...
//			Session["pk_CrMoLrnPtrn_ID"]=null;
			...
			try
			{
				...
				if(ds.Tables[0].Rows.Count>0)
				{
					...
					lblProvisionalReason.Text=ds.Tables[0].Rows[0]["PendingReason"].ToString();
                ...
                {
                    lblProfileHeading.Text = "Candidate " + ds.Tables[2].Rows[0]["First_Name"].ToString() + " is Marked Provisionally Eligible for the Course : " + ds.Tables[0].Rows[0]["CoursePart"].ToString();
		...
		{
			if(Request.QueryString["Search"] == "Simple")
				Server.Transfer("reg_ResolveProvisionalEligibility.aspx?Navigate=back&Search=Simple");
			if(Request.QueryString["Search"] == "Adv")
                Server.Transfer("reg_ResolveProvisionalEligibility.aspx?Navigate=back&Search=Adv");
                    ...
                    try
                    {
                        ...
                        else if ((flag == "2") /* ||(flag == "3")*/) // Pending--Commented by Shivani on 3rd Jan 2008
                        {
                            ...
                            {*/
                                ...
                                Cache["PRN"] = lblPRN.Text;
                            //}
                            lblProvisionalReason.Text = tbReason.Text;
                            if (flag == "2")
                            {
