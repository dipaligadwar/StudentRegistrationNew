<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" Codebehind="ELGV2_ResolveProvisional__2.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_ResolveProvisional__2" Culture="auto"
                ...
                <td valign="top" align="left">
                    <div id="divPendingReason" style="display: block" runat="server">
                        ...
                        <asp:Label ID="lblEligibilityReason" runat="server" Width="100%" CssClass="GridHeadingM"
                            Font-Bold="True" Text="Eligibility Kept Provisional due to following reason(s)"
                            meta:resourcekey="lblEligibilityReasonResource1"></asp:Label>
                        <table class="tblBackColor" id="Tbl1" cellspacing="1" cellpadding="3" width="100%"
                            border="0">
                            <tbody>
                                <tr class="rFont">
                                    <td style="height: 19px">
                                        <asp:Label ID="lblProvisionalReason" runat="server" CssClass="lblreason" Font-Bold="True"
                                            meta:resourcekey="lblProvisionalReasonResource1"></asp:Label></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div id="divStudentDetails" style="display: none" runat="server">
                        ...
                        <asp:Label ID="lblProfileHeading" runat="server" Width="100%" CssClass="GridHeadingM"
                            Height="18px" meta:resourcekey="lblProfileHeadingResource1" Text="Provisionally Eligible Student's Profile"></asp:Label><br>
                        <br>
                        ...
                        <div id="divInstructions" style="border-right: green solid; border-top: green solid;
                                ...
                                <tr>
                                    <td class="GridHeadingMI" width="100%">
                                        <asp:Label ID="lblInstructionHead" runat="server" Height="18px" meta:resourcekey="lblInstructionHeadResource1"
                                            Text="Instructions for Provisional Eligibility Decision"></asp:Label></td>
                                    <td align="right">
                            ...
                            <div id="divIScroll" style="overflow: auto; height: 200px" runat="server">
                                ...
                                <br>
                                <ol>
                                    <li><font color="black">Please view the displayed profile of the student whose Provisional
                                            ...
                                            <li><font color="black">Tick the check box against the document ,if the hard copy of
                                                ...
                                                <li><font color="black">Determine the validity of the received documents by marking
                                                    ...
                                                    <li><font color="black">Take the eligibility decision by marking 'Eligible' / 'Not Eligible'
                                                        / 'Pending Eligible' / 'Provisionally Eligible'.</font><br>
                                                        <br>
                                                        <li><font color="black">Take the eligibility decision by marking 'Eligible' / 'Not Eligible'
                                                            / 'Pending Eligible' / 'Provisionally Eligible'.</font><br>
                                                            <br>
                        ...
                        <table class="tblBackColor" cellspacing="1" cellpadding="3" width="100%" border="0">
                            ...
                            <tr class="rFont">
                                <td valign="top" width="30%">
                                    <b>
                                        <asp:Label ID="lblPermanentRegNumber" runat="server" Text="Permanent Registration Number"
                                            meta:resourcekey="lblPermanentRegNumberResource1"></asp:Label>
                                    </b>
                        ...
                        <table class="tblBackColor" id="Tbl4" cellspacing="1" cellpadding="3" width="100%"
                            ...
                            <tr class="rFont">
                                <td valign="top" align="center" width="100%">
                                    &nbsp;<asp:GridView ID="DGSubmittedDocs1" runat="server" Width="90%" BorderStyle="Solid" DataKeyNames="AdmissionMode"
                        ...
                        <div id="divEligibilityDecision" style="display: block" runat="server">
                            ...
                            <div id="divOldReason" style="display: none" runat="server">
                                <table class="tblBackColor" id="Table18" cellspacing="1" cellpadding="3" width="100%">
                                    <tr class="rFont">
                                        <td valign="top" width="39%">
                                            <b>Existing Reason(s) for Provisional Eligibility </b>
                                        </td>
                                        <td>
                    ...
                    <input id="hidCrMoLrnID" type="hidden" name="hidCrMoLrnID" runat="server" />
