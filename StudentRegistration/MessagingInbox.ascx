		...
		<td vAlign="top" align="center" bgColor="#eeefe9">
			<table cellpadding="0" cellspacing="5" width="100%" border="0">
				<tr id="TR1" runat="server">
					<td align="right" valign="top" style="PADDING-TOP: 5px"><img src='<%=UniversityPortal.clsGetSettings.SitePath%>Images/bullet1.gif'></td>
				...
				<tr id="TRMore" runat="server">
					<td style="COLOR: #dedfd4" align="right" valign="top" colspan="2">
						<a href='<%=UniversityPortal.clsGetSettings.SitePath+UniversityPortal.clsGetSettings.MessagingFolder%>/inboxMail.aspx'>
							more... </a>
					</td>
				</tr>
			</table>
