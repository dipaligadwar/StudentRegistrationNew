<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" CodeBehind="ELGV2_ResolvePending_reg_Students__2.aspx.cs"
    Inherits="StudentRegistration.Eligibility.ELGV2_ResolvePending_reg_Students__2"
        ...
        <table id="table1" style="border-collapse: collapse" bordercolor="#c0c0c0" cellpadding="2"
            ...
            <tr height="15">
                ...
                <td align="left" style="border-bottom: 1px solid #FFD275;">
                    ...
                    <asp:Label ID="lblStudName" runat="server" Font-Size="Small" Font-Bold="True" meta:resourcekey="lblStudNameResource1"></asp:Label></td>
            </tr>
            <tr>
                    ...
                    <p>
                        ...
                        <div id="divStudentDetails" style="display: none" runat="server">
                            ...
                            <table class="tblBackColor" cellspacing="1" cellpadding="3" width="100%" border="0">
                                ...
                                <tr class="rFont">
                                    <td valign="top" width="30%">
                                        <b>
                                            <asp:Label ID="lblPermanentRegisNumber" runat="server" Text="Permanent Registration Number"
                                                meta:resourcekey="lblPermanentRegisNumberResource1"></asp:Label></b>
                            ...
                            <table class="tblBackColor" cellspacing="1" cellpadding="3" width="100%" border="0">
                                ...
                                <%--<tr class="GridSubHeading">
											<td style="HEIGHT: 16px" vAlign="top" colSpan="4"><b>Permanent Registration Number :
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												</b>
												<asp:label id="lblPRNNo" runat="server" Font-Bold="True"></asp:label></td>
										</tr>--%>
                            </table>
                            <br>
                                    ...
                                    <td>
                                        <asp:GridView ID="DGQualification1" runat="server" Width="100%" BorderColor="Gainsboro"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CollegeInstituteName" HeaderText="College" meta:resourcekey="BoundFieldResource10">
                                                    <HeaderStyle Font-Bold="True" CssClass="gridHeader" HorizontalAlign="Center"></HeaderStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Body" HeaderText="University" meta:resourcekey="BoundFieldResource11">
                                                    <HeaderStyle Font-Bold="True" CssClass="gridHeader" HorizontalAlign="Center"></HeaderStyle>
                                                </asp:BoundField>
                                ...
                                <div id="divOldReason" style="display: none" runat="server">
                                    <table class="tblBackColor" id="Table11" cellspacing="1" cellpadding="3" width="100%">
                                        <tr class="rFont">
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbOldReason" runat="server" Width="466px" CssClass="textarea" Height="30px"
