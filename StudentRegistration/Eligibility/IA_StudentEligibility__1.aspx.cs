...
namespace StudentRegistration.Eligibility
{
	...
	/// </summary>
	public partial class IA_StudentEligibility__1 : System.Web.UI.Page
    {
		...
		{
			if(Request.QueryString["Search"] == "Simple")
				Server.Transfer("IA_StudentEligibility.aspx?Navigate=back&Search=Simple");
			if(Request.QueryString["Search"] == "Adv")
				Server.Transfer("IA_StudentEligibility.aspx?Navigate=back&Search=Adv");
        }
        ...
        protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
            if (GoToDataBase == 1)
            {
                ...
                int Error;
                strArr = clsEligibilityDBAccess.Register_Fresh_Student(arr[0], arr[2], arr[1], arr[3], ElgDecision, sReason, hidCrMoLrnPtrnID.Value, userid, sb);
                PRN = strArr[0];
                ...
                if (Error == 0)             // Modified by Madhu Poclassery on 06th Oct 2007 for SMS Integration
                {
                    ...
                    try
                    {
                        ...
                        {
                            lblPRN.Text = "The Student <b><i>" + lblNameOfStudent.Text + "</i></b> is marked as <Font color='#c00000' size='2'>" + ElgDescription + "</Font><br>for the Course " + lblCourse.Text;
                            Cache["PRN"] = lblPRN.Text;
                        ...
                        {
                            lblPRN.Text = "The Student <b><i>" + lblNameOfStudent.Text + "</i></b> is marked <br><Font color='#c00000' size='2'>" + ElgDescription + "</Font><br> for the Course " + lblCourse.Text;
                            Cache["PRN"] = lblPRN.Text;
