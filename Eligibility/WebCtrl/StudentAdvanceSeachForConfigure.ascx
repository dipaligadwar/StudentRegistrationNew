<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentAdvanceSeachForConfigure.ascx.cs"
    Inherits="StudentRegistration.Eligibility.WebCtrl.StudentAdvanceSeachForConfigure" %>
    ...
    <table id="Table4" cellspacing="0" width="100%" border="0">
        ...
        <tr style="display: inline">
            <td style="width: 953px; height: 317px;" align="center" colspan="3">
                <table id="tblDGElgRegular" style="display: inline" width="100%" runat="server">
                    <tr runat="server">
                        <td runat="server">
                            <asp:GridView ID="dgElgRegular1" runat="server" Width="100%" BorderWidth="1px" BorderStyle="Solid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CourseName" ReadOnly="True" HeaderText="Course Admitted To" SortExpression="CourseName"
                                        meta:resourcekey="BoundFieldResource3">
                                        <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DocCount" HeaderText="No of Documents Submitted" SortExpression="DocCount" meta:resourcekey="BoundFieldResource4">
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                    </asp:BoundField>
                        ...
                        <td runat="server">
                            <asp:GridView ID="dgRegPendingStudents1" runat="server" Width="100%" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="InstituteName" ReadOnly="True" HeaderText="College Name" SortExpression="InstituteName"
                                    ...
                                    <asp:BoundField DataField="DocCount" SortExpression="DocCount" HeaderText="No of Documents Submitted" meta:resourcekey="BoundFieldResource9">
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <HeaderStyle CssClass="gridHeader" HorizontalAlign="Center" />
                                    </asp:BoundField>
