<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.Master" CodeBehind="MatchingProfile__2.aspx.cs" Inherits="StudentRegistration.Eligibility.MatchingProfile__2" %>
...
.mergeProfiles
{
    width: 95%; padding: 15px; margin: 10px 0px 0px 0px;height:140px;
...
.mergeProfileChild
{
    ...
    height: 140px;font-family:Verdana;font-size:8pt;
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#fffacd, endColorstr=#fffeee);
}
.mergeProfileChild1
{
    float: left;width:58%;padding:10px 15px 10px 5px;.
    text-align:justify;font-family:Verdana;font-size:9pt;
}
.mergeProfileChild2
{
    float: left;width:36%;margin:10px 0px 10px 0px;
    padding:0px 0px 0px 10px;border-left:dashed 1px #c0c0c0;
...
.RequestInfoClass
{
    background-color:#fffacd;text-align:left;color:#006E12;
    font-family:Verdana;font-size:11pt;width:100%;
    padding:5px 2px 2px 40px;margin:5px 0px 2px 0px;
    background-image:url(../images/Info.jpg);   
    background-position:1% 15%;background-repeat:no-repeat;
}
</style> 
...
<tr>
    <td align="left" style="width: 100%;" colspan="2">
        <asp:Label ID="lblInfo" runat="server" meta:resourcekey="lblInfoResource1" CssClass="RequestInfoClass" Height="30px"></asp:Label>
    </td>
</tr>
<tr>
...
<br />
    ...
    <table width="95%" border="0" cellpadding="1" cellspacing="1">
        <tr>
            ...
            <th valign="top" align="left" style="width: 200px; border-left: dashed 1px #D1D1D1; padding-left: 15px;">
                <asp:Label ID="lblListCat" runat="server" meta:resourcekey="lblListCatResource1"></asp:Label>
            </th>
        </tr>
        <tr>
            <td valign="top" align="left">
                <asp:CheckBoxList ID="CBListFilter1" RepeatLayout="Flow" runat="server" CssClass="chkBox" meta:resourcekey="CBListFilter1Resource1">
                </asp:CheckBoxList>
            </td>
            <td valign="top" align="left" style="width: 200px; border-left: dashed 1px #D1D1D1;
                padding-left: 15px;">
                <asp:CheckBoxList ID="CBListFilter2" runat="server" RepeatLayout="Flow" CssClass="chkBox" meta:resourcekey="CBListFilter2Resource1">
                </asp:CheckBoxList>
            </td>
        </tr>
    </table>
        ...
        <div align="left" class="tblContents">
            <asp:Table ID="TBLSummery" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px"
                ...
                <asp:TableRow meta:resourcekey="TableRowResource3" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource3" runat="server" Text="
			                Student Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource4" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource4" runat="server" Text="
    ...
    <div id="divPerInfo" align="left" style="width: 700px;" class="clOff"><br />
        <div class="subHeading" align="left">
        ...
        <div align="left" class="tblContents">
            <asp:Table ID="TblPersonalInfo" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px"
                ...
                <asp:TableRow meta:resourcekey="TableRowResource6" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource6" runat="server" Text="
			                Student's Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource7" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource7" runat="server" Text="
			                Mother's Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource8" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource8" runat="server" Text="
			                Father's Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource9" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource9" runat="server" Text="
			                Name as printed on statement of marks of qualifying Exam
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource10" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource10" runat="server" Text="
			                Name in Vernacular language
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource11" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource11" runat="server" Text="
			                Marital Status
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource12" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource12" runat="server" Text="
			                Gender
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource13" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource13" runat="server" Text="
			                Date of Birth
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource14" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource14" runat="server" Text="
			                Place of Birth
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource15" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource15" runat="server" Text="
			                Blood Group
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource16" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource16" runat="server" Text="
			                Religion
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource17" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource17" runat="server" Text="
			                Previous Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource18" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource18" runat="server" Text="
			                Reason for Changing Name
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource19" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource19" runat="server" Text="
			                Country of Citizenship
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource20" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource20" runat="server" Text="
			                Location Category
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource21" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource21" runat="server" Text="
			                Correspondence Address
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource22" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource22" runat="server" Text="
			                Correspondence Tahsil
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource23" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource23" runat="server" Text="
			                Correspondence District
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource24" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource24" runat="server" Text="
			                Correspondence State
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource25" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource25" runat="server" Text="
			                Correspondence Country
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource26" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource26" runat="server" Text="
			                Permanent Address
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource27" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource27" runat="server" Text="
			                Permanent Tahsil
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource28" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource28" runat="server" Text="
			                Permanent District
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource29" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource29" runat="server" Text="
			                Permanent State
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource30" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource30" runat="server" Text="
			                Permanent Country
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource31" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource31" runat="server" Text="
			                [STD Code] Phone # 1
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource32" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource32" runat="server" Text="
			                [STD Code] Phone # 2
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource33" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource33" runat="server" Text="
			                Mobile Number
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource34" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource34" runat="server" Text="
			                Email ID
                    "></asp:TableHeaderCell>
                </asp:TableRow>
            </asp:Table>
    ...
    <div id="divQual" align="left" style="width: 700px;" class="clOff">
        ...
        <div align="left" class="tblContents">
            <asp:Table ID="TblQual" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px"
                ...
                <asp:TableRow  runat="server">
                    <asp:TableHeaderCell runat="server" >
                        <asp:Label ID="lbl10ExSeatNo" runat="server" Text="10th Examination Seat Number" meta:resourcekey="lbl10ExSeatNoResource1"></asp:Label>
                    </asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow  runat="server">
                    <asp:TableHeaderCell runat="server" >
                ...
                <asp:TableRow runat="server">
                    <asp:TableHeaderCell runat="server" >
                        <asp:Label ID="lbl12ExSeatNo" runat="server" Text="12th Examination Seat Number" meta:resourcekey="lbl12ExSeatNoResource1"></asp:Label>
                    </asp:TableHeaderCell>
                </asp:TableRow>
            </asp:Table>
        </div>
        ...
        <div align="left" class="tblContents">
            <asp:Table ID="TblSocRes" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px"
                ...
                <asp:TableRow meta:resourcekey="TableRowResource45" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource45" runat="server" Text="
			                Social Reservations
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource46" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource46" runat="server" Text="
			                Domicile of State
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource47" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource47" runat="server" Text="
			                Category
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource48" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource48" runat="server" Text="
			                Reserved Category
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource49" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource49" runat="server" Text="
			                Caste
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource50" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource50" runat="server" Text="
			                Admitted Under Category
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource51" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource51" runat="server" Text="
			                Physically Challenged
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource52" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource52" runat="server" Text="
			                Annual Income of Guardian
                    "></asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow meta:resourcekey="TableRowResource53" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource53" runat="server" Text="
    ...
    <div id="divCourse" align="left" style="width: 700px;" class="clOff">
        <div class="subHeading" align="left">
            ...
            <asp:Label ID="lblCourseProHead" runat="server" Text=":: Course Profile" Font-Bold="True" Font-Names="Verdana" Font-Size="11pt" meta:resourcekey="lblCourseProHeadResource1" ></asp:Label></div>
            <div style="float:right;font-family:Verdana;font-size:8pt;"><b>NOTE</b> : <font style="color:Red"># </font>Indicates performance not active.</div>
        </div>
        <div align="left" class="tblContents" >
            <asp:Table ID="TblCourse" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px" CssClass="OFFGrid" meta:resourcekey="TblCourseResource1">
                <asp:TableRow  runat="server">
                    <asp:TableHeaderCell runat="server" >
    ...
    <div id="divCollege" align="left" style="width: 700px;" class="clOff">
        ...
        <div align="left" class="tblContents" >
            <asp:Table ID="TblCollege" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px" CssClass="OFFGrid" meta:resourcekey="TblCollegeResource1">
                <asp:TableRow  runat="server" meta:resourcekey="TableRowResource56">
                    <asp:TableHeaderCell runat="server" meta:resourcekey="TableHeaderCellResource68">
                        College
                    </asp:TableHeaderCell>
                </asp:TableRow>
            </asp:Table>
        ...
        <div align="left" class="tblContents">
                <asp:Table ID="Table1" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px"
                    ...
                    <asp:TableRow ID="TableRow1" meta:resourcekey="TableRowResource55" runat="server">
                        <asp:TableHeaderCell BackColor="White" ID="TableHeaderCell1" Width="100%" 
...
"></asp:TableHeaderCell>
        ...
        <div align="left" class="tblContents">
            <asp:Table ID="TblAction" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0px" CssClass="OFFGrid" meta:resourcekey="TblActionResource1">
                <asp:TableRow meta:resourcekey="TableRowResource55" runat="server">
                    <asp:TableHeaderCell meta:resourcekey="TableHeaderCellResource55" runat="server" Text="Delete Matching Profile"></asp:TableHeaderCell>
                </asp:TableRow>
            </asp:Table>
        </div>
        <div align="left" class="tblContents">
    ...
    <div id="DIVMergeProfile" class="mergeProfiles" align="left">
        <div class="mergeProfileChild">
            <div class="mergeProfileChild1">
                "Merge Profiles" will combine the student profile with the base student profile.
                The Personal Information, Qualification Details, Social Reservation details of the student will not 
                be combined with the base student profile. Only the Course details, Exam details and Result details will get 
                combined. On successful merge the student will get deleted permanently.</div>
            <div class="mergeProfileChild2">    
                <%--<div class="mergeProfileChild3">
                    <asp:Label runat="server" ID="lblSelectPRN" Text="Select Profile" Font-Bold="true"></asp:Label><br /><br />
                    <asp:RadioButton runat="server" ID="rb1" Text="Profile 1" GroupName="prnRB" /><br />
                    <asp:RadioButton ID="rb2" runat="server" GroupName="prnRB" Text="Profile 2" />
                </div>--%>
...
<script type="text/javascript" language="javascript">
    ...
    function ValidateMerge()
    {
        ...
        (
            function()
            {
                if($(this).is(":checked"))                
                {
                    if(document.getElementById("<%=hid_BaseStudentIDs.ClientID%>").value != $(this).parent().attr("id"))
                    {
                        document.getElementById("<%=hid_ProfileToBeMerged.ClientID%>").value = $(this).parent().attr("id")
                    }
                }
            }
        )
        ...
        //ShowConfirm(UniqueID,"The other student profile will get merged with the selected Base Profile and will get deleted permanantly.<br\><br\>Are you sure you wish to merge the profiles?");
        //return false;
    }
    ...
    {  
        ...
        //
        //Disable the base profile
        //
        $("#<%=CBListFilter1.ClientID%>").find("#"+$("#<%=hid_BaseStudentIDs.ClientID%>").attr("value")).attr("disabled","disabled");
        //
       ...
       if($("#<%=CBListFilter1.ClientID%>").find("input[type='checkbox']:checked").length==1)
        ...
        // 
        //Get base profiles PRN
        //
        document.getElementById("<%=hidBasePRN.ClientID%>").value = $("#<%=TBLSummery.ClientID%>").find("TR:first").find("TD.clOn:first").find("div").html();
        //
        //Disable Delete button for Base profile
        //
        $("#divAction").find("#<%=TblAction.ClientID%>").find("TR:first").find("TD.clOn:first").find("input[type='submit']").attr("disabled", "disabled");
        //
        //Black borders
        //
