<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ELGV2rptUploadedStudentStatistics_CoursePartLessThanOneYear.aspx.cs" Inherits="StudentRegistration.Eligibility.ELGV2rptUploadedStudentStatistics_CoursePartLessThanOneYear" MasterPageFile="~/Home.Master" %>
                ...
                <div id="divDGStat" style="display: none;" runat="server" align="center">
                    <asp:GridView ID="GVStat" runat="server" AutoGenerateColumns="False" OnRowDataBound="GVStat_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Total Admissions Confirmed Count" HeaderText="Admissions confirmed by Study Center"
                                meta:resourcekey="BoundFieldResource4">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                            <asp:BoundField DataField="UnRegistered Student Count" HeaderText="PRN Not Generated Students Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                            <asp:BoundField DataField="UnRegistered Eligibility Processed Count" HeaderText="Eligibility Processed Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                             <asp:BoundField DataField="UnRegistered Eligibility UnProcessed Count" HeaderText="Eligibility Pending Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                              <asp:BoundField DataField="Registered Student Count" HeaderText="Already PRN generated Students Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                             <asp:BoundField DataField="Registered Eligibility Processed Count" HeaderText="Eligibility Processed Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
                             <asp:BoundField DataField="Registered Eligibility UnProcessed Count" HeaderText="Eligibility UnProcessed Count">
                                <ItemStyle Width="100px" HorizontalAlign="Right" />
                                <HeaderStyle CssClass="gridHeader" />
                            </asp:BoundField>
