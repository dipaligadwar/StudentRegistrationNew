...
<%@ Page language="c#" Codebehind="GoldServices.aspx.cs" AutoEventWireup="True" Inherits="SOADelivery.GoldServices" enableViewState="False"%>
					...
					<tr>
						...
						<td valign="top" align="center" width="725" colspan="3" height="380">
							<table cellspacing="1" cellpadding="1" width="100%">
									...
									<tr>
										<td colspan="3"><uc1:ucbreadcrumb id="UcBreadCrumb1" runat="server"></uc1:ucbreadcrumb></td>
									</tr>
									<tr>
										<td valign="top" width="33%"><asp:literal id="G1" runat="server"></asp:literal></td>
										<td valign="top" width="34%"><asp:literal id="G2" runat="server"></asp:literal></td>
										<td valign="top" width="33%"><asp:literal id="G3" runat="server"></asp:literal></td>
									</tr>
									<tr>
										<td valign="top" colspan="3">
											<table cellspacing="1" cellpadding="1" width="100%" border="0">
												<tr>
													<td valign="top" width="50%"><asp:literal id="G4" runat="server"></asp:literal></td>
													<td valign="top" width="50%"><asp:literal id="G5" runat="server"></asp:literal></td>
												</tr>
											</table>
										</td>
									</tr>
